...
class wrDB
{
    ...
    */
    ...
    private function audit($method = 'false', $query = 'false', $msg = '' , $audit = true){
     ...
     *
     */
    public function insert( $table, $variables = array() , $log = false , $audit = true , $returnId = false )
    {
        $rv  = false;
        $sql = '';
        $msg = '';
    ...
    * @return bool
    */
    public function insert_safe( $table, $variables = array() ,  $log = false , $audit = true  )
    {
        $rv  = false;
        $sql = '';
        $msg = '';
     ...
     *
     */
    public function insert_multi( $table, $columns = array(), $records = array() , $pFilter = false , $log = false , $audit = true)
    {
        $rv  = false;
        $sql = '';
        $msg = '';
        try {        
            ...
            if (is_array($records[$firstKey]) ){
                ...
                if( count( $records ) == $number_columns ) {
                    if ($pFilter) {
                        $records = $this->filter($record);    //sanitize data
                    }
                    foreach( $record as $value ) {  
                        if ( is_null($value ) ){
                            $values[] = 'NULL';
     ...
     *
     */
    public function update( $table, $variables = array(), $where = array(), $limit = '' , $safe = true , $audit = true)
    {
        $rv  = false;
        $sql = '';
        $msg = '';
     ...
     *
     */
    public function updateExtended( $table, $variables = array(), $extended = array() , $where = array(), $limit = '' , $safe = true , $audit = true)
    {
        $rv  = false;
        $sql = '';
        $msg = '';
     ...
     *
     */
    public function delete( $table, $where = array(), $limit = '' , $log = false , $audit = true)
    {
        self::$counter++;
    ...
    public function cloneRow( $table = false , $pkValue = false , $pkName = 'id' , $audit = true , $log = false){
        $rv = [
    ...
    private function fileCreate($fileName , $fileHeader , $fileDescription){
        ...
        // write header
        $this->fileWrite( $h , $fileHeader , true);
